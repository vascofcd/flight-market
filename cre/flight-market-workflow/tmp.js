...
var onCronTrigger = (runtime2) => {
  ...
  const result = runtime2.runInNodeMode(fetchMathResult, consensusMedianAggregation())().result();
  runtime2.log(`Successfully fetched and aggregated math result: ${result}`);
  return {
    result
  };
};
